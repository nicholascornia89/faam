...
[JSON :material-code-json:](http://nicholascornia89.github.io/faam/json/jtE66RbA.json){.md-button} [RDF Turtle :material-cable-data:](http://nicholascornia89.github.io/faam/rdf/jtE66RbA.ttl){.md-button} [CSV :material-table:](http://nicholascornia89.github.io/faam/csv/jtE66RbA.csv){.md-button}

<img style="float: left;" src="https://commons.wikimedia.org/w/index.php?title=Special:Redirect/file/Simrock_Dvorak_5.jpg" width="250" height="200">

!!! abstract "metadata" 

    | FAAM UUID | label      | aliases                | description                     | Wikidata QID                                            |
    | :-------: | :--------: | :--------------------: | :-----------------------------: | :-----------------------------------------------------: |
    | jtE66RbA  | N. Simrock | Musikverlag N. Simrock | German music publishing company | [N. Simrock](http://wwww.wikidata.org/entity/Q17114100) |
...
<iframe src="../network/jtE66RbA.html" height="800" width="1200" title="jtE66RbA"></iframe>
...
!!! info "IMSLP ID" 
	...
	[N._Simrock](https://imslp.org/wiki/N._Simrock)

!!! info "VIAF ID" 

	[127272364](https://viaf.org/viaf/127272364)

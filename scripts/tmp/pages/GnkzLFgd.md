...
# Biblioteca Nacional de España (GnkzLFgd)
...
!!! abstract "metadata" 
    ...
    | :-------: | :---------------------------: | :--------------: | :-----: | :-----------------------------------------------------------------: | :----------: |
    | GnkzLFgd  | Biblioteca Nacional de España | library in Spain | BNE     | [Biblioteca Nacional de España](http://wikidata.org/entity/Q750403) | BNE          |
...
!!! quote "website" 
	...
	[external URL](https://bdh.bne.es/)

	[external URL](https://bdh.bne.es/bnesearch/Inicio.do)
...
<iframe src="https://nicholascornia89.github.io/faam/network/GnkzLFgd" height="800" width="1200" title="GnkzLFgd"></iframe>

...
[JSON :material-code-json:](https://nicholascornia89.github.io/faam/json/7aDqcqbB.json){.md-button} [RDF Turtle :material-cable-data:](https://nicholascornia89.github.io/faam/rdf/7aDqcqbB.ttl){.md-button} [CSV :material-table:](https://nicholascornia89.github.io/faam/csv/7aDqcqbB.csv){.md-button}

<img style="float: left;" src="https://commons.wikimedia.org/w/index.php?title=Special:Redirect/file/ErnstPauerLudwigAngerer.jpg" width="250" height="200">

!!! abstract "metadata" 

    | FAAM UUID | label       | aliases     | description                                         | Wikidata QID                                     |
    | :-------: | :---------: | :---------: | :-------------------------------------------------: | :----------------------------------------------: |
    | 7aDqcqbB  | Ernst Pauer | Ernst Pauer | Austrian pianist, composer and educator (1826–1905) | [Ernst Pauer](http://wikidata.org/entity/Q79183) |
...
??? quote "employer" 
	...
	- [University of Cambridge](./mg5miPgR.md)

## Knowledge graph

---

<iframe src="https://nicholascornia89.github.io/faam/network/7aDqcqbB" height="800" width="1200" title="7aDqcqbB"></iframe>
...
!!! info "IMSLP ID" 
	...
	[Category:Pauer,_Ernst](https://imslp.org/wiki/Category:Pauer,_Ernst)

!!! info "VIAF ID" 

	[37182448](https://viaf.org/viaf/37182448)

!!! info "RISM ID" 

	[people/6147](https://rism.online/people/6147)

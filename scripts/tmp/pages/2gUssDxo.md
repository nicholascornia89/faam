...
[JSON :material-code-json:](https://nicholascornia89.github.io/faam/json/2gUssDxo.json){.md-button} [RDF Turtle :material-cable-data:](https://nicholascornia89.github.io/faam/rdf/2gUssDxo.ttl){.md-button} [CSV :material-table:](https://nicholascornia89.github.io/faam/csv/2gUssDxo.csv){.md-button}

<img style="float: left;" src="https://commons.wikimedia.org/w/index.php?title=Special:Redirect/file/https://www.svm.be/files/Componisten/KEURVELS-Edward-INDEXFOTO-K040.18.jpg" width="250" height="200">

!!! abstract "metadata" 

    | FAAM UUID | label           | aliases         | description                                           | Wikidata QID                                           |
    | :-------: | :-------------: | :-------------: | :---------------------------------------------------: | :----------------------------------------------------: |
    | 2gUssDxo  | Edward Keurvels | Edward Keurvels | Belgian conductor and co-founder of the Flemish Opera | [Edward Keurvels](http://wikidata.org/entity/Q2750289) |
...
??? quote "employer" 
	...
	- [Royal Society for Zoology Antwerp](./GK7UXWTC.md)

## Knowledge graph

---

<iframe src="https://nicholascornia89.github.io/faam/network/2gUssDxo" height="800" width="1200" title="2gUssDxo"></iframe>
...
!!! info "IMSLP ID" 
	...
	[Category:Keurvels,_Edward](https://imslp.org/wiki/Category:Keurvels,_Edward)

!!! info "VIAF ID" 

	[63583397](https://viaf.org/viaf/63583397)

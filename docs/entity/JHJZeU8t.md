...
# Air Varie : pour la flûte, avec accompagnement de piano, sur un motif favori de l'opéra Le mauvais oeil: (JHJZeU8t)
...
???  "musical work" 
	...
	- [Le Mauvais-œil](./4Zg3E8qp.md)

	- [Air Varié pour la flûte, Op. 8](./Fy72RCta.md)

??? abstract "agent" 

    | agent                        | role                       | place                     | date |
    | :--------------------------: | :------------------------: | :-----------------------: | :--: |
    | [Michel Folz](./5Ze3Bk9Z.md) | [composer](./YvQmwaaW.md)  |                           |      |
    | [Loïsa Puget](./nu6Thpo8.md) | [composer](./YvQmwaaW.md)  |                           |      |

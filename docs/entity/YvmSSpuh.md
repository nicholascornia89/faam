...
# Come esser può ch’io viva (YvmSSpuh)
...
!!! abstract "metadata" 
    ...
    | :-------: | :-----------------------: | :-----: | :---------: | :----------------------------------: |
    | YvmSSpuh  | Come esser può ch’io viva |         |             | [](http://wwww.wikidata.org/entity/) |
...
<iframe src="../network/YvmSSpuh.html" height="800" width="1200" title="YvmSSpuh"></iframe>
...
!!! info "IMSLP ID" 
	...
	[Come esser può ch’io viva (Gesualdo, Carlo)](https://imslp.org/wiki/Come esser può ch’io viva (Gesualdo, Carlo))

...
!!! abstract "metadata" 
    ...
    | :-------: | :-------------------: | :---------------------------------------------------------------------------: | :---------------: | :------------------------------------------: |
    | GepDoTXn  | string number (sul X) | string or wire that vibrates in a string instrument to produce a musical tone | instrument string | [string](http://wikidata.org/entity/Q326426) |
...
<iframe src="https://nicholascornia89.github.io/faam/network/GepDoTXn" height="800" width="1200" title="GepDoTXn"></iframe>

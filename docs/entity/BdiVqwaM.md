...
# Ecce quomodo moritur iustus (BdiVqwaM)
...
!!! abstract "metadata" 
    ...
    | :-------: | :-------------------------: | :-----: | :---------: | :----------------------------------: |
    | BdiVqwaM  | Ecce quomodo moritur iustus |         |             | [](http://wwww.wikidata.org/entity/) |
...
<iframe src="../network/BdiVqwaM.html" height="800" width="1200" title="BdiVqwaM"></iframe>
...
!!! info "IMSLP ID" 
	...
	[Ecce quomodo moritur iustus (Handl, Jacob)](https://imslp.org/wiki/Ecce quomodo moritur iustus (Handl, Jacob))

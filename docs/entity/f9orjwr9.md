...
# O quam gloriosum est regnum (f9orjwr9)
...
!!! abstract "metadata" 
    ...
    | :-------: | :-------------------------: | :-----: | :---------: | :-----------------------------: |
    | f9orjwr9  | O quam gloriosum est regnum |         |             | [](http://wikidata.org/entity/) |
...
<iframe src="https://nicholascornia89.github.io/faam/network/f9orjwr9" height="800" width="1200" title="f9orjwr9"></iframe>
...
!!! info "IMSLP ID" 
	...
	[O quam gloriosum est regnum (Victoria, Tomás Luis de)](https://imslp.org/wiki/O quam gloriosum est regnum (Victoria, Tomás Luis de))

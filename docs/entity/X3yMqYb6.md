...
# Musica Sacra: tijdschrift voor kerkzang en gewijde muziek (X3yMqYb6)
...
!!! abstract "metadata" 
    ...
    | :-------: | :-------------------------------------------------------: | :---------: | :-----: | :----------------------------------: |
    | X3yMqYb6  | Musica Sacra: tijdschrift voor kerkzang en gewijde muziek |             |         | [](http://wwww.wikidata.org/entity/) |
...
<iframe src="../network/X3yMqYb6.html" height="800" width="1200" title="X3yMqYb6"></iframe>

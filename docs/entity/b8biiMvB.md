...
# Fantaisie : pour la Flûte avec Accomp. des Quatuor ou Piano : Sur l'Opéra de D.F.E Auber Le Dieu et la Bayadère : Op. 42 (b8biiMvB)
...
???  "musical work" 
	...
	- [Le Dieu et la Bayadère](./hG5PERE4.md)

??? abstract "agent" 

    | agent                                         | role                       | place                     | date |
    | :-------------------------------------------: | :------------------------: | :-----------------------: | :--: |
    | [Daniel François Esprit Auber](./Q9hzqiq3.md) | [composer](./YvQmwaaW.md)  |                           |      |
    | [Eugène Walckiers](./NTvBj8eb.md)             | [composer](./YvQmwaaW.md)  |                           |      |

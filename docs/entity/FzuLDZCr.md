...
[JSON :material-code-json:](https://nicholascornia89.github.io/faam/json/FzuLDZCr.json){.md-button} [RDF Turtle :material-cable-data:](https://nicholascornia89.github.io/faam/rdf/FzuLDZCr.ttl){.md-button} [CSV :material-table:](https://nicholascornia89.github.io/faam/csv/FzuLDZCr.csv){.md-button}

<img style="float: left;" src="https://commons.wikimedia.org/w/index.php?title=Special:Redirect/file/Lucchini-Bellini.jpg" width="250" height="200">

!!! abstract "metadata" 

    | FAAM UUID | label            | aliases | description                        | Wikidata QID                                           |
    | :-------: | :--------------: | :-----: | :--------------------------------: | :----------------------------------------------------: |
    | FzuLDZCr  | Vincenzo Bellini | Bellini | Italian opera composer (1801–1835) | [Vincenzo Bellini](http://wikidata.org/entity/Q170209) |
...
<iframe src="https://nicholascornia89.github.io/faam/network/FzuLDZCr" height="800" width="1200" title="FzuLDZCr"></iframe>
...
!!! info "IMSLP ID" 
	...
	[Category:Bellini,_Vincenzo](https://imslp.org/wiki/Category:Bellini,_Vincenzo)

!!! info "VIAF ID" 

	[39560983](https://viaf.org/viaf/39560983)

!!! info "RISM ID" 

	[people/11648](https://rism.online/people/11648)
